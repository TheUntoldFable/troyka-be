...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    addressInfo: Attribute.JSON & Attribute.Required;
    billingAddressInfo: Attribute.JSON;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::order.order',
      'oneToOne',
    ...
    > &
      Attribute.Private;
    credentialsInfo: Attribute.JSON & Attribute.Required;
    ...
    publishedAt: Attribute.DateTime;
    status: Attribute.Enumeration<['active', 'finished', 'cancelled']> &
      Attribute.Required &
    ...
    > &
      Attribute.Private;
    user: Attribute.String & Attribute.DefaultTo<'null'>;
  };
}
